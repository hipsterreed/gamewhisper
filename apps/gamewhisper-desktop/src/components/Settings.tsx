  ...
  return (
    <div className="space-y-2">
      ...
      {user && (
        <button
          onClick={signOut}
          className="w-full py-2.5 rounded-xl text-sm font-medium text-red-400 border border-red-500/20 bg-red-500/[0.06] hover:bg-red-500/[0.12] hover:border-red-500/40 hover:text-red-300 transition-all"
        >
          Sign out
        </button>
      )}
